...
import { Category, CategoryDispatch, CategoryFrom } from "../../types/category";
...
export const addCategory = (form: CategoryFrom) => async (dispatch: CategoryDispatch) => {
...
export const updateCategory = (form: Partial<CategoryFrom>, categoryId: number) => async (dispatch: CategoryDispatch) => {
